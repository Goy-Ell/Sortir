 ...
 * @UniqueEntity(fields={"email"}, message="Email déjà prit, veuillez choisir un autre email")
 * @UniqueEntity(fields={"pseudo"}, message="Pseudo déjà prit, veuillez choisir un autre pseudo")
 */
